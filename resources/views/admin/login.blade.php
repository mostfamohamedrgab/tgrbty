...
<head>
  ...
  <link href="{{asset('public/admin/dist/css/sb-admin-2.min.css')}}" rel="stylesheet">
                ...
                <div class="p-5">
                  ...
                  <form class="user" action="{{ route('admin.login') }}" method="post">
                    ...
                    <div class="form-group">
                      <input type="email" required="required" name="email" class="form-control form-control-user"  placeholder="البريد الالكتروني ">
                    </div>
                    <div class="form-group">
